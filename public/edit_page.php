...
<?php
//unlike the new_page.php, we don't need a subject_id to be sent
	...
	<div id="main">
		...
		<div id="page">
			...
			<form action="edit_page.php?page=<?php echo urldecode($current_page["id"]); ?>" method="post">
				...
				<p>
					Visible: <input type="radio" name="visible" value="0" <?php if ($current_page["visible"] == 0) {
                                                                echo "checked";
                                                            } ?> />No
                                &nbsp;
                ...
                <p>
                    Content: <br> 
                            <TextArea name="content" cols="80" rows="10"><?php echo htmlentities($current_page["content"]); ?>
                            </textArea>
                </p>
